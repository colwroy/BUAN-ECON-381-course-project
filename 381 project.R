...
############################################################
#tuned gradient boosted tree outperforms base multivariate slightly (RMSE = ~1109)

#base multivariate model 2nd (RMSE = 1124), 
#followed by ridge regularized version 3rd (RMSE = 1127)
#on validation set
#############################################################
